...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-forgotpassword-forgotpassword-module"], {
  ...
  function srcAppPagesForgotpasswordForgotpasswordPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var ForgotpasswordPage = /*#__PURE__*/function () {
      function ForgotpasswordPage(router, commonService, authService, sessionStorage) {
          ...
          if (this.mobileNo) {
            ...
            this.authService.forgotpassword(formData).subscribe(function (response) {
              ...
              if (response['status'] == 1) {
                _this.commonService.showSuccess("OTP is sent to your mobile number."); //this.sessionStorage.mobileNo=this.mobileNo;


                _this.sessionStorage.setData("mobile", _this.mobileNo);

                _this.router.navigate(['/forgotpassvlidateotp']);
              } else {
