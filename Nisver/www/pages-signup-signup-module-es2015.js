...
/* harmony import */ var _model_session_storage_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../model/session-storage.service */ "./src/app/model/session-storage.service.ts");
...
let SignupPage = class SignupPage {
    constructor(formBuilder, http, loadingController, mapsAPILoader, ngZone, toastController, commonService, router, sessionStorage, apiservice) {
    ...
    postData() {
        ...
        this.http.post('http://nisver.com/addon/api/registration.php', formData, { responseType: 'json' }).subscribe((response) => {
...
], SignupPage.prototype, "searchElementRef", void 0);
