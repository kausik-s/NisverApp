...
let ProfilePage = class ProfilePage {
    constructor(router, formBuilder, http, loadingController, mapsAPILoader, ngZone, toastController, commonService, apiservice) {
        this.router = router;
...
], ProfilePage.prototype, "searchElementRef", void 0);
