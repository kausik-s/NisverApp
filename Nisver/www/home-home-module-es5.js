    ...
    var routes = [{
      ...
      children: [{
        ...
        loadChildren: function loadChildren() {
          ...
          /*! import() | pages-pendingorder-pendingorder-module */
          "pages-pendingorder-pendingorder-module").then(__webpack_require__.bind(null,
          /*! ../pages/pendingorder/pendingorder.module */
          "./src/app/pages/pendingorder/pendingorder.module.ts")).then(function (m) {
            return m.PendingorderPageModule;
          });
        }
      }, {
        path: 'vendorsearch',
        loadChildren: function loadChildren() {
          return __webpack_require__.e(
          /*! import() | pages-vendorsearch-vendorsearch-module */
          "pages-vendorsearch-vendorsearch-module").then(__webpack_require__.bind(null,
          /*! ../pages/vendorsearch/vendorsearch.module */
          "./src/app/pages/vendorsearch/vendorsearch.module.ts")).then(function (m) {
            return m.VendorsearchPageModule;
          });
        }
      }, {
        path: 'orderhistory',
        loadChildren: function loadChildren() {
          return __webpack_require__.e(
          /*! import() | pages-orderhistory-orderhistory-module */
          "pages-orderhistory-orderhistory-module").then(__webpack_require__.bind(null,
          /*! ../pages/orderhistory/orderhistory.module */
          "./src/app/pages/orderhistory/orderhistory.module.ts")).then(function (m) {
        ...
        loadChildren: function loadChildren() {
          return __webpack_require__.e(
          /*! import() | pages-bookinghistory-bookinghistory-module */
          "pages-bookinghistory-bookinghistory-module").then(__webpack_require__.bind(null,
          /*! ../pages/bookinghistory/bookinghistory.module */
          "./src/app/pages/bookinghistory/bookinghistory.module.ts")).then(function (m) {
            return m.BookinghistoryPageModule;
          });
        }
      }, {
        path: '',
